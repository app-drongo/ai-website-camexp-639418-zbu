...
const DEFAULT_HERO = {
  badge: 'New: AI-Powered Receipt Recognition',
  title: 'Capture expenses instantly with',
  titleHighlight: "CamExp's Smart Camera",
  description:
    'Transform your phone into a powerful expense tracking tool. Snap photos of receipts, invoices, and business documents - our AI automatically extracts and organizes everything for your small business.',
  features: [
  ...
  imageAlt: 'CamExp mobile app scanning receipt',
  statsLabel1: 'Accuracy Rate',
  statsValue1: '99.2% OCR',
  statsLabel2: 'Time Saved',
  statsValue2: '5 hrs/week',
} as const;
